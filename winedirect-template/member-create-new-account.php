...
<div class="winedirect-wrapper error">
  ...
  <div class="member">
    ...
    <div id="v65-memberFormWrapper">
      <form method="post" class="v65-form" action="/index.cfm?method=memberCreateAccount.ProcessSignup">
        ...
        <fieldset>
          ...
          <div>
            ...
            <select name="BirthMonth" id="v65-billBirthMonth">
            ...
            <select name="BirthDay" id="v65-billBirthDay">
            ...
            <select name="BirthYear" id="v65-billBirthYear">
          ...
          <div>
            ...
            <input type="text" name="smsNumber" value="">
          </div>
          <div>
            <label for="smsPermissionStatus">SMS Permission</label> 
            <select name="smsPermissionStatus">
          ...
          <div>
            ...
            <select name="emailStatus" v65js="emailPermissionStatus">
              <option value="">Not Set</option>
              <option value="OptIn">Opt In</option>
              <option value="OptOut">Opt Out</option>
            </select>
          </div>
          <div v65js="googleRecaptcha" class="v65-formRecaptcha googleRecaptchaInUse" id="googleRecaptchaAccountSignup">
            <div style="width: 304px; height: 78px;">
              <div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LdQvBYTAAAAAP5Oi5g9ScTmALNxw3QegVXko56Q&amp;co=aHR0cHM6Ly9zaG9wLm1pY2hhZWxkYXZpZHdpbmVyeS5jb206NDQz&amp;hl=en&amp;v=v1526338122299&amp;size=normal&amp;cb=sugbf1immp3o" width="304" height="78" role="presentation" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div>
