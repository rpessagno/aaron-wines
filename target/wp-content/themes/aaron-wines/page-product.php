  ...
  <script type="text/html" id="product-custom">
    <div class="product" data-bind="with: product">
      ...
      <div class="product-content">
        <h1 class="product-title subtitle" data-bind="text: Custom2"></h1>
        <h1 class="product-title text" data-bind="text: Custom3"></h1>
        <h3 class="product-price" data-bind="text: '$' + Price"></h3>
