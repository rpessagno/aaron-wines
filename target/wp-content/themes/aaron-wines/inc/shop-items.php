  ...
  <script type="text/html" id="shop-custom">
    <div data-bind="foreach: parentProducts" class="shop-items">
      ...
      <div class="shop-item">
        ...
        <h2 class="shop-item-title subtitle"><a data-bind="text: Title, attr: { href: '/shop/product/?item=' + Tag }"></a></h2>
        <h3 class="shop-item-price subtitle2" data-bind="text: '$' + Price"></h3>
